...
<div class="bg-[#fff5d2]  flex h-screen items-center flex-col">
        ...
        <p>Editar Clase</p>
            <form class="space-y-4" action="/editClase" method="post">
               
                <input type="text" hidden name="id" value="<?=$clase[0]["ID_Clase"]?>">

                <input class="border border-gray-300 rounded-md p-1" type="text" name="nombreClase" value="<?=$clase[0]["NombreClase"]?>">
