                            ...
                            <thead class="ltr:text-left rtl:text-right">
                                <tr>
                                    ...
                                    <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                                        ...
                                        <a href="/adminClasesCreateView" class="inline-block rounded w-10 px-4 text-sky-600 hover:text-sky-300 text-center"><span class="material-symbols-outlined">add_box</span></a>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                foreach ($dataAlumnos as $alumnos) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap px-4 py-2 text-gray-700"><?= $ID_Maestro ?></td>
                                        <td class="whitespace-nowrap px-4 py-2">
                                            <div class="flex">
                                                ...
                                                <a href="/adminClasesEditView?id=<?=$ID_Clase?>" class="inline-block rounded w-10 px-4 text-sky-600 hover:text-sky-300 text-center">
