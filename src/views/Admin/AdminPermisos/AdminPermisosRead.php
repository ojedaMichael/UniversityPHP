...
session_start();
$dataUsuarios = $_SESSION["usuarios"];
                                ...
                                foreach ($dataUsuarios as $usuarios) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap px-4 py-2">
                                            <div class="flex">
                                                <a href="/adminPermisosEditView?id=<?=$ID_Usuario?>" class="inline-block rounded w-10 px-4 text-sky-600 hover:text-sky-300 text-center">
